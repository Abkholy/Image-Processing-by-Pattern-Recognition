...
public class HomeController implements Initializable {
    ...
    protected void handleReloadButtonAction(ActionEvent event) {
        ...
        enhancementCombo.setDisable(true);
    ...
    public void handleBrowseButtonAction(ActionEvent actionEvent) throws IOException {
        ...
        if (file != null) {
            ...
            enhancementCombo.setDisable(false);
    ...
    private ComboBox <String> enhancementCombo; // Value injected by FXMLLoader
    ...
    public void ProcessAction(ActionEvent actionEvent) {
        try {
            ...
            String value = enhancementCombo.getSelectionModel().selectedItemProperty().getValue();
            switch (value) {
                case "Zoom In": {
